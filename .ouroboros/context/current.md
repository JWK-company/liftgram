...
- **후속/미구현**: 매니지드 인증 실연동(어댑터 준비됨) · 공개 프로필 화면(SRS-008) · 미디어 모더레이션(SAD-012) · DM 실시간·그룹(ADR-015) · notifications(SRS-020) · 결제(SAD-013, 앱 완성 후) · 자동카운팅(SRS-012, 보류). 실행: `server/README.md`.
