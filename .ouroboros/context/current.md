...
- **후속/미구현**: 매니지드 인증 실연동(어댑터 준비됨) · 미디어 모더레이션(SAD-012) · DM 실시간(ADR-015·그룹은 구현됨) · 푸시 알림 · 결제(SAD-013, 앱 완성 후) · 자동카운팅(SRS-012, 보류). 실행: `server/README.md`.
## 차단 요소
